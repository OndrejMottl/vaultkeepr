...
The goal of vaultkeepr is to providing the interface to access the [**VegVault** database](https://ondrejmottl.github.io/VegVault/).
...
vaultkeepr provides a pipe-friendly interface to the [VegVault](https://ondrejmottl.github.io/VegVault/) database. Functions are designed to be chained together to build a lazy query plan that is executed in full with a single call to `extract_data()`.
...
For detailed worked examples, see the [package website](https://hope-uib-bio.github.io/vaultkeepr/articles/).
